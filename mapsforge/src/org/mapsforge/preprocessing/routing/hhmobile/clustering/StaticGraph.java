...
public class StaticGraph {
	...
	private StaticGraph(int[] vFirstOutboundEdge, int[] eWeight, int[] eTarget) {
	...
	public static StaticGraph buildHHGraph(Connection conn, int lvl) throws SQLException {
		...
		return new StaticGraph(vFirstOutboundEdge, eWeight, eTarget);
	}
	...
	public static void main(String[] args) throws SQLException {
		...
		StaticGraph g = buildHHGraph(conn, 1);
