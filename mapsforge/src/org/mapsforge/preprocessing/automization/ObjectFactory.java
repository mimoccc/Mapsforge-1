 ...
 * interface generated in the org.mapsforge.preprocessing.automization package.
 * <p>
...
public class ObjectFactory {
	...
	private final static QName _Sink_QNAME = new QName(
			"http://mapsforge.org/mapsforge-preprocessing-conf", "sink");
	private final static QName _MapfileWriter_QNAME = new QName(
			"http://mapsforge.org/mapsforge-preprocessing-conf", "mapfile-writer");
	private final static QName _BboxAreaFilter_QNAME = new QName(
			"http://mapsforge.org/mapsforge-preprocessing-conf", "bbox-area-filter");
	private final static QName _Configuration_QNAME = new QName(
			"http://mapsforge.org/mapsforge-preprocessing-conf", "configuration");
	private final static QName _ReadPbf_QNAME = new QName(
			"http://mapsforge.org/mapsforge-preprocessing-conf", "read-pbf");
	private final static QName _WritePbf_QNAME = new QName(
			"http://mapsforge.org/mapsforge-preprocessing-conf", "write-pbf");
	...
	private final static QName _SinkSource_QNAME = new QName(
			"http://mapsforge.org/mapsforge-preprocessing-conf", "sink-source");
	private final static QName _Source_QNAME = new QName(
			"http://mapsforge.org/mapsforge-preprocessing-conf", "source");

	/**
	 * Create a new ObjectFactory that can be used to create new instances of schema derived
	 * classes for package: org.mapsforge.preprocessing.automization
	 * 
	 */
	...
	public JAXBElement<PolygonAreaFilter> createPolygonAreaFilter(PolygonAreaFilter value) {
		return new JAXBElement<PolygonAreaFilter>(_PolygonAreaFilter_QNAME,
				PolygonAreaFilter.class, null, value);
	}
	...
	public JAXBElement<MapfileWriter> createMapfileWriter(MapfileWriter value) {
		return new JAXBElement<MapfileWriter>(_MapfileWriter_QNAME, MapfileWriter.class, null,
				value);
	}
	...
	public JAXBElement<BboxAreaFilter> createBboxAreaFilter(BboxAreaFilter value) {
		return new JAXBElement<BboxAreaFilter>(_BboxAreaFilter_QNAME, BboxAreaFilter.class,
				null, value);
	}
	...
	public JAXBElement<Configuration> createConfiguration(Configuration value) {
		return new JAXBElement<Configuration>(_Configuration_QNAME, Configuration.class, null,
				value);
	}
	...
	public JAXBElement<RoutinggraphWriter> createRoutinggraphWriter(RoutinggraphWriter value) {
		return new JAXBElement<RoutinggraphWriter>(_RoutinggraphWriter_QNAME,
				RoutinggraphWriter.class, null, value);
	}
