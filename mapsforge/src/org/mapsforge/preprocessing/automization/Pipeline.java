...
public class Pipeline {
	...
	/**
	 * Generate the osmosis calls of the hole pipeline. Starting by the Source and traverse the
	 * tree downstairs. The path of the output directory would be actualized.
	 * 
	 * @param md5List
