...
enum WayEnum {
	...
	HIGHWAY$MOTORWAY(WayType.HIGHWAY, (byte) 6),
	HIGHWAY$MOTORWAY_LINK(WayType.HIGHWAY, (byte) 6),
	...
	HIGHWAY$SECONDARY_LINK(WayType.HIGHWAY, (byte) 9),
	...
	HIGHWAY$TRUNK(WayType.HIGHWAY, (byte) 6),
	HIGHWAY$TRUNK_LINK(WayType.HIGHWAY, (byte) 6),
	...
	NATURAL$GLACIER(WayType.NATURAL, (byte) 8),
	...
	SPORT$SWIMMING(WayType.UNCLASSIFIED, (byte) 15),
