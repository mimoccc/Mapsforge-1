 ...
 */
class CoastlineWay {
	static final byte SIDE_BOTTOM = 1;
	static final byte SIDE_LEFT = 2;
	static final byte SIDE_RIGHT = 0;
	static final byte SIDE_TOP = 3;
	...
	static boolean isClockWise(float[] coastline) {
		...
		for (int currentNode = 0; currentNode < coastline.length; currentNode += 2) {
			int nextNode = (currentNode + 2) % coastline.length;
