...
public class Filter {
	static TreeMap<String, Byte> getNodeFilter() {
		...
		filter.put("place=island", Byte.valueOf((byte) 13));
		filter.put("place=suburb", Byte.valueOf((byte) 14));
		filter.put("place=town", Byte.valueOf((byte) 10));
	...
	static TreeMap<String, Byte> getWayFilter() {
		...
		filter.put("admin_level=2", Byte.valueOf((byte) 8));
		filter.put("admin_level=4", Byte.valueOf((byte) 13));
		...
		filter.put("aeroway=helipad", Byte.valueOf((byte) 17));
		filter.put("aeroway=runway", Byte.valueOf((byte) 12));
		filter.put("aeroway=taxiway", Byte.valueOf((byte) 12));
		...
		filter.put("highway=cycleway", Byte.valueOf((byte) 15));
		filter.put("highway=footway", Byte.valueOf((byte) 15));
		filter.put("highway=living_street", Byte.valueOf((byte) 15));
		filter.put("highway=motorway", Byte.valueOf((byte) 10));
		filter.put("highway=motorway_link", Byte.valueOf((byte) 10));
		filter.put("highway=path", Byte.valueOf((byte) 15));
		filter.put("highway=pedestrian", Byte.valueOf((byte) 15));
		filter.put("highway=primary", Byte.valueOf((byte) 10));
		filter.put("highway=primary_link", Byte.valueOf((byte) 10));
		filter.put("highway=residential", Byte.valueOf((byte) 14));
		filter.put("highway=road", Byte.valueOf((byte) 13));
		filter.put("highway=secondary", Byte.valueOf((byte) 12));
		filter.put("highway=service", Byte.valueOf((byte) 15));
		filter.put("highway=steps", Byte.valueOf((byte) 16));
		filter.put("highway=tertiary", Byte.valueOf((byte) 13));
		filter.put("highway=track", Byte.valueOf((byte) 13));
		filter.put("highway=trunk", Byte.valueOf((byte) 13));
		filter.put("highway=trunk_link", Byte.valueOf((byte) 13));
		filter.put("highway=unclassified", Byte.valueOf((byte) 15));

		filter.put("historic=ruins", Byte.valueOf((byte) 17));

		filter.put("landuse=allotments", Byte.valueOf((byte) 13));
		filter.put("landuse=basin", Byte.valueOf((byte) 15));
		filter.put("landuse=brownfield", Byte.valueOf((byte) 13));
		filter.put("landuse=cemetery", Byte.valueOf((byte) 13));
		filter.put("landuse=commercial", Byte.valueOf((byte) 13));
		filter.put("landuse=construction", Byte.valueOf((byte) 15));
		filter.put("landuse=farm", Byte.valueOf((byte) 13));
		filter.put("landuse=farmland", Byte.valueOf((byte) 13));
		filter.put("landuse=forest", Byte.valueOf((byte) 13));
		filter.put("landuse=grass", Byte.valueOf((byte) 15));
		filter.put("landuse=greenfield", Byte.valueOf((byte) 15));
		filter.put("landuse=industrial", Byte.valueOf((byte) 13));
		filter.put("landuse=military", Byte.valueOf((byte) 13));
		filter.put("landuse=recreation_ground", Byte.valueOf((byte) 13));
		filter.put("landuse=reservoir", Byte.valueOf((byte) 13));
		filter.put("landuse=residential", Byte.valueOf((byte) 13));
		filter.put("landuse=retail", Byte.valueOf((byte) 13));
		filter.put("landuse=village_green", Byte.valueOf((byte) 13));
		filter.put("landuse=wood", Byte.valueOf((byte) 13));

		filter.put("leisure=common", Byte.valueOf((byte) 13));
		filter.put("leisure=garden", Byte.valueOf((byte) 15));
		filter.put("leisure=golf_course", Byte.valueOf((byte) 13));
		filter.put("leisure=park", Byte.valueOf((byte) 13));
		filter.put("leisure=pitch", Byte.valueOf((byte) 15));
		filter.put("leisure=playground", Byte.valueOf((byte) 16));
		filter.put("leisure=sports_centre", Byte.valueOf((byte) 13));
		filter.put("leisure=stadium", Byte.valueOf((byte) 13));
		...
		filter.put("military=airfield", Byte.valueOf((byte) 13));
		filter.put("military=barracks", Byte.valueOf((byte) 13));
		...
		filter.put("natural=water", Byte.valueOf((byte) 13));
		filter.put("natural=wood", Byte.valueOf((byte) 13));

		filter.put("place=locality", Byte.valueOf((byte) 17));

		filter.put("railway=light_rail", Byte.valueOf((byte) 13));
		filter.put("railway=rail", Byte.valueOf((byte) 13));
		...
		filter.put("route=ferry", Byte.valueOf((byte) 14));
		...
		filter.put("waterway=canal", Byte.valueOf((byte) 13));
		filter.put("waterway=drain", Byte.valueOf((byte) 14));
		filter.put("waterway=river", Byte.valueOf((byte) 13));
		filter.put("waterway=riverbank", Byte.valueOf((byte) 13));
		filter.put("waterway=stream", Byte.valueOf((byte) 14));
