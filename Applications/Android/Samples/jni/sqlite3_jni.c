...
static jclass C_org_sqlite_android_exception = 0;

static jfieldID F_org_sqlite_android_Database_handle = 0;
static jfieldID F_org_sqlite_android_Database_error_code = 0;
static jfieldID F_org_sqlite_android_FunctionContext_handle = 0;
static jfieldID F_org_sqlite_android_Vm_handle = 0;
static jfieldID F_org_sqlite_android_Vm_error_code = 0;
static jfieldID F_org_sqlite_android_Stmt_handle = 0;
static jfieldID F_org_sqlite_android_Stmt_error_code = 0;
static jfieldID F_org_sqlite_android_Blob_handle = 0;
static jfieldID F_org_sqlite_android_Blob_size = 0;
static jfieldID F_org_sqlite_android_Backup_handle = 0;
...
static void seterr(JNIEnv *env, jobject obj, int err) {
	...
	v.j = 0;
	v.i = (jint) err;
	(*env)->SetIntField(env, obj, F_org_sqlite_android_Database_error_code, v.i);
}
...
static void setvmerr(JNIEnv *env, jobject obj, int err) {
	...
	v.j = 0;
	v.i = (jint) err;
	(*env)->SetIntField(env, obj, F_org_sqlite_android_Vm_error_code, v.i);
}
...
static void setstmterr(JNIEnv *env, jobject obj, int err) {
	...
	v.j = 0;
	v.i = (jint) err;
	(*env)->SetIntField(env, obj, F_org_sqlite_android_Stmt_error_code, v.i);
}
...
gethandle(JNIEnv *env, jobject obj) {
	...
	v.j = (*env)->GetLongField(env, obj, F_org_sqlite_android_Database_handle);
	return (void *) v.l;
}
...
gethvm(JNIEnv *env, jobject obj) {
	...
	v.j = (*env)->GetLongField(env, obj, F_org_sqlite_android_Vm_handle);
	return (void *) v.l;
}
...
gethstmt(JNIEnv *env, jobject obj) {
	...
	v.j = (*env)->GetLongField(env, obj, F_org_sqlite_android_Stmt_handle);
	return (void *) v.l;
}
...
gethbl(JNIEnv *env, jobject obj) {
	...
	v.j = (*env)->GetLongField(env, obj, F_org_sqlite_android_Blob_handle);
	return (void *) v.l;
}
...
gethbk(JNIEnv *env, jobject obj) {
	...
	v.j = (*env)->GetLongField(env, obj, F_org_sqlite_android_Backup_handle);
	return (void *) v.l;
}
...
static void throwex(JNIEnv *env, const char *msg) {
	...
	if (!C_org_sqlite_android_exception)
		C_org_sqlite_android_exception = (*env)->FindClass(env, "org/sqlite/android/SQLiteException");
	if (C_org_sqlite_android_exception) {
		(*env)->ThrowNew(env, C_org_sqlite_android_exception, msg);
	}
}
...
static void doclose(JNIEnv *env, jobject obj, int final) {
	...
	if (h) {
		...
		while ((f = h->funcs)) {
			...
			if (f->fc) {
				(*env)->SetLongField(env, f->fc,
						F_org_sqlite_android_FunctionContext_handle, 0);
			}
		...
		free(h);
		(*env)->SetLongField(env, obj, F_org_sqlite_android_Database_handle, 0);
		return;
	}
	if (!final) {
		throwclosed(env);
...
Java_org_sqlite_android_Database__1close(JNIEnv *env, jobject obj) {
	doclose(env, obj, 0);
}

JNIEXPORT void JNICALL
Java_org_sqlite_android_Database__1finalize(JNIEnv *env, jobject obj) {
	doclose(env, obj, 1);
}

JNIEXPORT void JNICALL
Java_org_sqlite_android_Database__1busy_1timeout(JNIEnv *env, jobject obj, jint ms) {
	handle *h = gethandle(env, obj);
...
Java_org_sqlite_android_Database_version(JNIEnv *env, jclass cls) {
	/* CHECK THIS */
	return (*env)->NewStringUTF(env, sqlite3_libversion());
}

JNIEXPORT jstring JNICALL
Java_org_sqlite_android_Database_dbversion(JNIEnv *env, jobject obj) {
	handle *h = gethandle(env, obj);
...
Java_org_sqlite_android_Database__1last_1insert_1rowid(JNIEnv *env, jobject obj) {
	handle *h = gethandle(env, obj);
...
JNIEXPORT jlong JNICALL
Java_org_sqlite_android_Database__1changes(JNIEnv *env, jobject obj) {
	handle *h = gethandle(env, obj);
...
Java_org_sqlite_android_Database__1complete(JNIEnv *env, jclass cls, jstring sql) {
	transstr sqlstr;
	jboolean result;
...
JNIEXPORT void JNICALL
Java_org_sqlite_android_Database__1interrupt(JNIEnv *env, jobject obj) {
	handle *h = gethandle(env, obj);
...
JNIEXPORT void JNICALL
Java_org_sqlite_android_Database__1open4(JNIEnv *env, jobject obj, jstring file,
	...
	if (h->sqlite) {
		...
		v.j = 0;
		v.l = (jobject) h;
		(*env)->SetLongField(env, obj, F_org_sqlite_android_Database_handle, v.j);
...
JNIEXPORT void JNICALL
Java_org_sqlite_android_Database__1open(JNIEnv *env, jobject obj, jstring file, jint mode) {
	Java_org_sqlite_android_Database__1open4(env, obj, file, mode, 0, 0);
}

JNIEXPORT void JNICALL
Java_org_sqlite_android_Database__1busy_1handler(JNIEnv *env, jobject obj, jobject bh) {
	handle *h = gethandle(env, obj);
...
JNIEXPORT void JNICALL
Java_org_sqlite_android_Database__1exec__Ljava_lang_String_2LSQLite3_Callback_2(
...
JNIEXPORT void JNICALL
Java_org_sqlite_android_Database__1exec__Ljava_lang_String_2LSQLite3_Callback_2_3Ljava_lang_String_2(
...
getfunc(JNIEnv *env, jobject obj) {
	...
	v.j = (*env)->GetLongField(env, obj, F_org_sqlite_android_FunctionContext_handle);
	return (hfunc *) v.l;
}
...
static void mkfunc_common(JNIEnv *env, int isagg, jobject obj, jstring name,
	...
	if (h && h->sqlite) {
		...
		v.j = 0;
		v.l = (jobject) f;
		(*env)->SetLongField(env, f->fc, F_org_sqlite_android_FunctionContext_handle, v.j);
...
JNIEXPORT void JNICALL
Java_org_sqlite_android_Database__1create_1aggregate(JNIEnv *env, jobject obj,
		jstring name, jint nargs, jobject fi) {
	mkfunc_common(env, 1, obj, name, nargs, fi);
}

JNIEXPORT void JNICALL
Java_org_sqlite_android_Database__1create_1function(JNIEnv *env, jobject obj,
		jstring name, jint nargs, jobject fi) {
	mkfunc_common(env, 0, obj, name, nargs, fi);
}

JNIEXPORT void JNICALL
Java_org_sqlite_android_Database__1function_1type(JNIEnv *env, jobject obj, jstring name,
		jint type) {
	handle *h = gethandle(env, obj);
...
Java_org_sqlite_android_FunctionContext_count(JNIEnv *env, jobject obj) {
...
JNIEXPORT void JNICALL
Java_org_sqlite_android_FunctionContext_set_1error(JNIEnv *env, jobject obj, jstring err) {
	hfunc *f = getfunc(env, obj);
...
JNIEXPORT void JNICALL
Java_org_sqlite_android_FunctionContext_set_1result__D(JNIEnv *env, jobject obj, jdouble d) {
	hfunc *f = getfunc(env, obj);
...
JNIEXPORT void JNICALL
Java_org_sqlite_android_FunctionContext_set_1result__I(JNIEnv *env, jobject obj, jint i) {
	hfunc *f = getfunc(env, obj);
...
JNIEXPORT void JNICALL
Java_org_sqlite_android_FunctionContext_set_1result__Ljava_lang_String_2(JNIEnv *env,
...
JNIEXPORT void JNICALL
Java_org_sqlite_android_FunctionContext_set_1result___3B(JNIEnv *env, jobject obj,
		jbyteArray b) {
	hfunc *f = getfunc(env, obj);
...
JNIEXPORT void JNICALL
Java_org_sqlite_android_FunctionContext_set_1result_1zeroblob(JNIEnv *env, jobject obj,
		jint n) {
	hfunc *f = getfunc(env, obj);
...
JNIEXPORT jstring JNICALL
Java_org_sqlite_android_Database_error_1string(JNIEnv *env, jclass c, jint err) {
	return (*env)->NewStringUTF(env, "unkown error");
}

JNIEXPORT jstring JNICALL
Java_org_sqlite_android_Database__1errmsg(JNIEnv *env, jobject obj) {
	handle *h = gethandle(env, obj);
...
JNIEXPORT void JNICALL
Java_org_sqlite_android_Database__1set_1encoding(JNIEnv *env, jobject obj, jstring enc) {
	handle *h = gethandle(env, obj);
...
JNIEXPORT void JNICALL
Java_org_sqlite_android_Database__1set_1authorizer(JNIEnv *env, jobject obj, jobject auth) {
	handle *h = gethandle(env, obj);
...
JNIEXPORT void JNICALL
Java_org_sqlite_android_Database__1trace(JNIEnv *env, jobject obj, jobject tr) {
	handle *h = gethandle(env, obj);
...
static void dovmfinal(JNIEnv *env, jobject obj, int final) {
	...
	if (v) {
		...
		free(v);
		(*env)->SetLongField(env, obj, F_org_sqlite_android_Vm_handle, 0);
		return;
	}
	if (!final) {
...
static void dostmtfinal(JNIEnv *env, jobject obj) {
	...
	if (v) {
		...
		v->vm = 0;
		free(v);
		(*env)->SetLongField(env, obj, F_org_sqlite_android_Stmt_handle, 0);
	}
}
...
static void doblobfinal(JNIEnv *env, jobject obj) {
	...
	if (bl) {
		...
		bl->blob = 0;
		free(bl);
		(*env)->SetLongField(env, obj, F_org_sqlite_android_Blob_handle, 0);
		(*env)->SetIntField(env, obj, F_org_sqlite_android_Blob_size, 0);
	}
}

JNIEXPORT void JNICALL
Java_org_sqlite_android_Vm_stop(JNIEnv *env, jobject obj) {
	dovmfinal(env, obj, 0);
}

JNIEXPORT void JNICALL
Java_org_sqlite_android_Vm_finalize(JNIEnv *env, jobject obj) {
	dovmfinal(env, obj, 1);
}
...
JNIEXPORT jboolean JNICALL
Java_org_sqlite_android_Vm_step(JNIEnv *env, jobject obj, jobject cb) {
	hvm *v = gethvm(env, obj);
...
JNIEXPORT jboolean JNICALL
Java_org_sqlite_android_Vm_compile(JNIEnv *env, jobject obj) {
	hvm *v = gethvm(env, obj);
	void *svm = 0;
	char *err = 0;
	const char *tail;
...
JNIEXPORT void JNICALL
Java_org_sqlite_android_Database_vm_1compile(JNIEnv *env, jobject obj, jstring sql,
		jobject vm) {
	handle *h = gethandle(env, obj);
	void *svm = 0;
	hvm *v;
	...
	vv.j = 0;
	vv.l = (jobject) v;
	(*env)->SetLongField(env, vm, F_org_sqlite_android_Vm_handle, vv.j);
}

JNIEXPORT void JNICALL
Java_org_sqlite_android_Database_vm_1compile_1args(JNIEnv *env, jobject obj, jstring sql,
...
JNIEXPORT void JNICALL
Java_org_sqlite_android_FunctionContext_internal_1init(JNIEnv *env, jclass cls) {
	F_org_sqlite_android_FunctionContext_handle = (*env)->GetFieldID(env, cls, "handle",
			"J");
}

JNIEXPORT void JNICALL
Java_org_sqlite_android_Database__1progress_1handler(JNIEnv *env, jobject obj, jint n,
		jobject ph) {
	handle *h = gethandle(env, obj);
...
JNIEXPORT jboolean JNICALL
Java_org_sqlite_android_Stmt_prepare(JNIEnv *env, jobject obj) {
	hvm *v = gethstmt(env, obj);
	void *svm = 0;
	char *tail;
	int ret;
...
JNIEXPORT void JNICALL
Java_org_sqlite_android_Database_stmt_1prepare(JNIEnv *env, jobject obj, jstring sql,
		jobject stmt) {
	handle *h = gethandle(env, obj);
	void *svm = 0;
	hvm *v;
	...
	vv.j = 0;
	vv.l = (jobject) v;
	(*env)->SetLongField(env, stmt, F_org_sqlite_android_Stmt_handle, vv.j);
}

JNIEXPORT jboolean JNICALL
Java_org_sqlite_android_Stmt_step(JNIEnv *env, jobject obj) {
	hvm *v = gethstmt(env, obj);
...
JNIEXPORT void JNICALL
Java_org_sqlite_android_Stmt_close(JNIEnv *env, jobject obj) {
	hvm *v = gethstmt(env, obj);
...
JNIEXPORT void JNICALL
Java_org_sqlite_android_Stmt_reset(JNIEnv *env, jobject obj) {
	hvm *v = gethstmt(env, obj);
...
JNIEXPORT void JNICALL
Java_org_sqlite_android_Stmt_clear_1bindings(JNIEnv *env, jobject obj) {
	hvm *v = gethstmt(env, obj);
...
JNIEXPORT void JNICALL
Java_org_sqlite_android_Stmt_bind__II(JNIEnv *env, jobject obj, jint pos, jint val) {
	hvm *v = gethstmt(env, obj);
...
JNIEXPORT void JNICALL
Java_org_sqlite_android_Stmt_bind__IJ(JNIEnv *env, jobject obj, jint pos, jlong val) {
	hvm *v = gethstmt(env, obj);
...
JNIEXPORT void JNICALL
Java_org_sqlite_android_Stmt_bind__ID(JNIEnv *env, jobject obj, jint pos, jdouble val) {
	hvm *v = gethstmt(env, obj);
...
JNIEXPORT void JNICALL
Java_org_sqlite_android_Stmt_bind__I_3B(JNIEnv *env, jobject obj, jint pos, jbyteArray val) {
	hvm *v = gethstmt(env, obj);
...
JNIEXPORT void JNICALL
Java_org_sqlite_android_Stmt_bind__ILjava_lang_String_2(JNIEnv *env, jobject obj,
...
JNIEXPORT void JNICALL
Java_org_sqlite_android_Stmt_bind__I(JNIEnv *env, jobject obj, jint pos) {
	hvm *v = gethstmt(env, obj);
...
JNIEXPORT void JNICALL
Java_org_sqlite_android_Stmt_bind_1zeroblob(JNIEnv *env, jobject obj, jint pos, jint len) {
	hvm *v = gethstmt(env, obj);
...
JNIEXPORT jint JNICALL
Java_org_sqlite_android_Stmt_bind_1parameter_1count(JNIEnv *env, jobject obj) {
	hvm *v = gethstmt(env, obj);
...
JNIEXPORT jstring JNICALL
Java_org_sqlite_android_Stmt_bind_1parameter_1name(JNIEnv *env, jobject obj, jint pos) {
	hvm *v = gethstmt(env, obj);
...
JNIEXPORT jint JNICALL
Java_org_sqlite_android_Stmt_bind_1parameter_1index(JNIEnv *env, jobject obj, jstring name) {
	hvm *v = gethstmt(env, obj);
...
JNIEXPORT jint JNICALL
Java_org_sqlite_android_Stmt_column_1int(JNIEnv *env, jobject obj, jint col) {
	hvm *v = gethstmt(env, obj);
...
JNIEXPORT jlong JNICALL
Java_org_sqlite_android_Stmt_column_1long(JNIEnv *env, jobject obj, jint col) {
	hvm *v = gethstmt(env, obj);
...
Java_org_sqlite_android_Stmt_column_1double(JNIEnv *env, jobject obj, jint col) {
	hvm *v = gethstmt(env, obj);
...
Java_org_sqlite_android_Stmt_column_1bytes(JNIEnv *env, jobject obj, jint col) {
	hvm *v = gethstmt(env, obj);
...
JNIEXPORT jstring JNICALL
Java_org_sqlite_android_Stmt_column_1string(JNIEnv *env, jobject obj, jint col) {
	hvm *v = gethstmt(env, obj);
...
JNIEXPORT jint JNICALL
Java_org_sqlite_android_Stmt_column_1type(JNIEnv *env, jobject obj, jint col) {
	hvm *v = gethstmt(env, obj);
...
JNIEXPORT jint JNICALL
Java_org_sqlite_android_Stmt_column_1count(JNIEnv *env, jobject obj) {
	hvm *v = gethstmt(env, obj);
...
JNIEXPORT jstring JNICALL
Java_org_sqlite_android_Stmt_column_1name(JNIEnv *env, jobject obj, jint col) {
	hvm *v = gethstmt(env, obj);
...
JNIEXPORT jstring JNICALL
Java_org_sqlite_android_Stmt_column_1table_1name(JNIEnv *env, jobject obj, jint col) {
	hvm *v = gethstmt(env, obj);
...
JNIEXPORT jstring JNICALL
Java_org_sqlite_android_Stmt_column_1database_1name(JNIEnv *env, jobject obj, jint col) {
	hvm *v = gethstmt(env, obj);
...
JNIEXPORT jstring JNICALL
Java_org_sqlite_android_Stmt_column_1decltype(JNIEnv *env, jobject obj, jint col) {
	hvm *v = gethstmt(env, obj);
...
JNIEXPORT jstring JNICALL
Java_org_sqlite_android_Stmt_column_1origin_1name(JNIEnv *env, jobject obj, jint col) {
	hvm *v = gethstmt(env, obj);
...
JNIEXPORT jint JNICALL
Java_org_sqlite_android_Stmt_status(JNIEnv *env, jobject obj, jint op, jboolean flg) {
	jint count = 0;
	hvm *v = gethstmt(env, obj);
...
JNIEXPORT void JNICALL
Java_org_sqlite_android_Stmt_finalize(JNIEnv *env, jobject obj) {
	dostmtfinal(env, obj);
}

JNIEXPORT void JNICALL
Java_org_sqlite_android_Database__1open_1blob(JNIEnv *env, jobject obj, jstring dbname,
	...
	if (h && h->sqlite) {
		...
		vv.j = 0;
		vv.l = (jobject) bl;
		(*env)->SetLongField(env, blobj, F_org_sqlite_android_Blob_handle, vv.j);
		(*env)->SetIntField(env, blobj, F_org_sqlite_android_Blob_size,
...
JNIEXPORT jint JNICALL
Java_org_sqlite_android_Blob_write(JNIEnv *env, jobject obj, jbyteArray b, jint off,
		jint pos, jint len) {
	hbl *bl = gethbl(env, obj);
...
JNIEXPORT jint JNICALL
Java_org_sqlite_android_Blob_read(JNIEnv *env, jobject obj, jbyteArray b, jint off,
		jint pos, jint len) {
	hbl *bl = gethbl(env, obj);
...
JNIEXPORT void JNICALL
Java_org_sqlite_android_Blob_close(JNIEnv *env, jobject obj) {
	doblobfinal(env, obj);
}

JNIEXPORT void JNICALL
Java_org_sqlite_android_Blob_finalize(JNIEnv *env, jobject obj) {
	doblobfinal(env, obj);
}

JNIEXPORT void
JNICALL Java_org_sqlite_android_Database__1key(JNIEnv *env, jobject obj, jbyteArray key) {
	jsize len;
	jbyte *data;
	handle *h = gethandle(env, obj);
...
JNIEXPORT void JNICALL
Java_org_sqlite_android_Database__1rekey(JNIEnv *env, jobject obj, jbyteArray key) {
	jsize len;
	jbyte *data;
	handle *h = gethandle(env, obj);
...
JNIEXPORT jboolean JNICALL
Java_org_sqlite_android_Database__1enable_1shared_1cache(JNIEnv *env, jclass cls,
		jboolean onoff) {
...
JNIEXPORT void JNICALL
Java_org_sqlite_android_Database__1backup(JNIEnv *env, jclass cls, jobject bkupj,
	...
	vv.j = 0;
	vv.l = (jobject) bk;
	(*env)->SetLongField(env, bkupj, F_org_sqlite_android_Backup_handle, vv.j);
	return;
}

JNIEXPORT void JNICALL
Java_org_sqlite_android_Backup__1finalize(JNIEnv *env, jobject obj) {
	...
	if (bk) {
		...
		bk->bkup = 0;
		free(bk);
		(*env)->SetLongField(env, obj, F_org_sqlite_android_Backup_handle, 0);
		if (ret != SQLITE_OK) {
...
JNIEXPORT jboolean JNICALL
Java_org_sqlite_android_Backup__1step(JNIEnv *env, jobject obj, jint n) {
...
JNIEXPORT jint JNICALL
Java_org_sqlite_android_Backup__1remaining(JNIEnv *env, jobject obj) {
	jint result = 0;
	hbk *bk = gethbk(env, obj);
...
JNIEXPORT jint JNICALL
Java_org_sqlite_android_Backup__1pagecount(JNIEnv *env, jobject obj) {
	jint result = 0;
	hbk *bk = gethbk(env, obj);
...
JNIEXPORT void JNICALL
Java_org_sqlite_android_Database__1profile(JNIEnv *env, jobject obj, jobject tr) {
	handle *h = gethandle(env, obj);
...
JNIEXPORT jint JNICALL
Java_org_sqlite_android_Database__1status(JNIEnv *env, jclass cls, jint op,
...
JNIEXPORT jint JNICALL
Java_org_sqlite_android_Database__1db_1status(JNIEnv *env, jobject obj, jint op,
		jintArray info, jboolean flag) {
	jint ret = SQLITE_ERROR;
	handle *h = gethandle(env, obj);
	int data[2] = { 0, 0 };
...
JNIEXPORT void JNICALL
Java_org_sqlite_android_Stmt_internal_1init(JNIEnv *env, jclass cls) {
	F_org_sqlite_android_Stmt_handle = (*env)->GetFieldID(env, cls, "handle", "J");
	F_org_sqlite_android_Stmt_error_code = (*env)->GetFieldID(env, cls, "error_code", "I");
}

JNIEXPORT void JNICALL
Java_org_sqlite_android_Vm_internal_1init(JNIEnv *env, jclass cls) {
	F_org_sqlite_android_Vm_handle = (*env)->GetFieldID(env, cls, "handle", "J");
	F_org_sqlite_android_Vm_error_code = (*env)->GetFieldID(env, cls, "error_code", "I");
}

JNIEXPORT void JNICALL
Java_org_sqlite_android_Blob_internal_1init(JNIEnv *env, jclass cls) {
	F_org_sqlite_android_Blob_handle = (*env)->GetFieldID(env, cls, "handle", "J");
	F_org_sqlite_android_Blob_size = (*env)->GetFieldID(env, cls, "size", "I");
}

JNIEXPORT void JNICALL
Java_org_sqlite_android_Backup_internal_1init(JNIEnv *env, jclass cls) {
	F_org_sqlite_android_Backup_handle = (*env)->GetFieldID(env, cls, "handle", "J");
}

JNIEXPORT void JNICALL
Java_org_sqlite_android_Database_internal_1init(JNIEnv *env, jclass cls) {
...
#endif
	F_org_sqlite_android_Database_handle = (*env)->GetFieldID(env, cls, "handle", "J");
	F_org_sqlite_android_Database_error_code = (*env)->GetFieldID(env, cls, "error_code",
			"I");
