...
public class MenuBar extends JMenuBar implements ActionListener {
	...
	public MenuBar(AdvancedMapViewerPC p) {
		...
		this.menuInfo.setIcon(new ImageIcon("res/drawable/ic_menu_info_details.png"));
		...
		this.menuPosition = new JMenu(propertiesStrings.getProperty("menu_position"));
		this.menuPosition.setIcon(new ImageIcon("res/drawable/ic_menu_mylocation.png"));
		...
		this.menuScreenshot = new JMenu(propertiesStrings.getProperty("menu_screenshot"));
		this.menuScreenshot.setIcon(new ImageIcon("res/drawable/ic_menu_camera.png"));
		...
		this.menuPreferences = new PreferencesMenu(parentFrame, propertiesStrings.getProperty("menu_preferences"));
		this.menuPreferences.setIcon(new ImageIcon("res/drawable/ic_menu_preferences.png"));
		...
		this.menuRenderTheme = new JMenu(propertiesStrings.getProperty("menu_render_theme"));
		...
		this.menuMapFile = new JMenu(propertiesStrings.getProperty("menu_mapfile"));
		...
		this.menuZoom = new JMenu(propertiesStrings.getProperty("preferences_zoom"));
		...
		//Menuitems
		this.itemMapinfo = new JMenuItem(propertiesStrings.getProperty("menu_info_map_file"),'m');
		this.itemMapinfo.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_F1,0));
		this.itemAbout = new JMenuItem(propertiesStrings.getProperty("menu_info_about"),'a');
		this.itemAbout.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_F2,0));
		
		this.itemFollowGPS = new JMenuItem(propertiesStrings.getProperty("menu_position_follow_gps_signal"),'f');
		this.itemFollowGPS.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_F3,0));
		this.itemFollowGPS.setEnabled(false);
		this.itemLastKnown = new JMenuItem(propertiesStrings.getProperty("menu_position_last_known"),'l');
		this.itemLastKnown.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_F, InputEvent.ALT_DOWN_MASK));
		this.itemEnterCoordiantes = new JMenuItem(propertiesStrings.getProperty("menu_position_enter_coordinates"),'e');
		this.itemEnterCoordiantes.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_F4, 0));
		this.itemMapFileCenter = new JMenuItem(propertiesStrings.getProperty("menu_position_map_file_center"),'c');
		this.itemMapFileCenter.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_F5, 0));
		
		this.itemJPEG = new JMenuItem(propertiesStrings.getProperty("menu_screenshot_jpeg"),'j');
		this.itemJPEG.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_F6,0));
		this.itemPNG = new JMenuItem(propertiesStrings.getProperty("menu_screenshot_png"),'p');
		this.itemPNG.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_F7,0));
		
		this.itemMapnik = new JMenuItem(propertiesStrings.getProperty("menu_render_theme_mapnik"),'m');
		this.itemMapnik.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_F9,0));
		this.itemOsmarenderer = new JMenuItem(propertiesStrings.getProperty("menu_render_theme_osmarender"),'o');
		this.itemOsmarenderer.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_F10,0));
		this.itemSelectXMLFile = new JMenuItem(propertiesStrings.getProperty("menu_render_theme_select_file"),'x');
		this.itemSelectXMLFile.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_F11,0));
		
		this.itemMapFile = new JMenuItem(propertiesStrings.getProperty("menu_mapfile_select_file"),'f');
		this.itemMapFile.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_F12,0));		
		
		this.itemZoomOut = new JMenuItem(propertiesStrings.getProperty("preferences_zoom_out"),'-');
		this.itemZoomOut.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_MINUS,0));
		this.itemZoomOut.setToolTipText(propertiesStrings.getProperty("preferences_zoom_out_desc"));
		this.itemZoomIn = new JMenuItem(propertiesStrings.getProperty("preferences_zoom_in"),'+');
		this.itemZoomIn.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_PLUS,0));
		this.itemZoomIn.setToolTipText(propertiesStrings.getProperty("preferences_zoom_in_desc"));
	...
	public void actionPerformed(ActionEvent e) {
		...
		else if (cmd.equals(propertiesStrings.getProperty("preferences_zoom_out"))) {
			//TODO: Zooming out
		}
		else if (cmd.equals(propertiesStrings.getProperty("preferences_zoom_in"))) {
			//TODO: Zooming in 
		}
