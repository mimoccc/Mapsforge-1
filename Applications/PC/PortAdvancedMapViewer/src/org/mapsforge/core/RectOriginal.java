...
public class RectOriginal {
	 ...
	 */
	public RectOriginal(GeoCoordinate gc) {
	 ...
	 *            bound of the rectangle.
	 */
	public RectOriginal(int minLongitudeE6, int maxLongitudeE6, int minLatitudeE6, int maxLatitudeE6) {
	 ...
	 *            bound of the rectangle.
	 */
	public RectOriginal(double minLongitude, double maxLongitude, double minLatitude, double maxLatitude) {
	 ...
	 */
	public RectOriginal(RectOriginal rect) {
	 ...
	 *             rectangle
	 */
	public static RectOriginal fromString(String rectString) {
		...
		return new RectOriginal(upperLeft.getLongitudeE6(), bottomRight.getLongitudeE6(),
	 ...
	 */
	public double distance(RectOriginal otherRect) {
	...
	public boolean equals(Object obj) {
		if (this == obj) {
			return true;
		} else if (!(obj instanceof RectOriginal)) {
			return false;
		} else {
			this.other = (RectOriginal) obj;
	 ...
	 */
	public void expandToInclude(RectOriginal otherRect) {
	 ...
	 * @return true if rectangles overlap.
	 */
	public boolean overlaps(RectOriginal r) {
