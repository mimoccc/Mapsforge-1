...
public final class Parcel {
     ...
     * @hide
     */
    //TODO public final void writeCharSequence(CharSequence val) {
     ...
     * growing dataCapacity() if needed.  The Map keys must be String objects.
     */
    public /* package */ void writeMapInternal(Map<String,Object> val) {
        if (val == null) {
            writeInt(-1);
            return;
        }
    ...
    /* package */ public void readMapInternal(Map outVal, int N,
        ClassLoader loader) {
        while (N > 0) {
