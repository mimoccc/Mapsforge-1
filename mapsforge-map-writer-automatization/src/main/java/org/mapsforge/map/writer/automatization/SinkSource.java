...
public abstract class SinkSource {
	...
	/**
	 * The default implementation for all sink-sources. Here is the call to split the pipe for each task that need this
	 * data as source. Also the osmosis call of each task would be generated. It is necessary that every implementation
	 * of a sink-source call the super constructor of this method to implement this too.
	 * 
	 * @param md5List
