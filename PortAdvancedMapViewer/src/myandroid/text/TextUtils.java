...
import myandroid.content.res.ColorStateList;
import myandroid.content.res.Resources;
import myandroid.os.Parcel;
import myandroid.os.Parcelable;
import myandroid.text.method.TextKeyListener.Capitalize;
import myandroid.text.style.AbsoluteSizeSpan;
import myandroid.text.style.AlignmentSpan;
import myandroid.text.style.BackgroundColorSpan;
import myandroid.text.style.BulletSpan;
import myandroid.text.style.CharacterStyle;
import myandroid.text.style.ForegroundColorSpan;
import myandroid.text.style.LeadingMarginSpan;
import myandroid.text.style.MetricAffectingSpan;
import myandroid.text.style.QuoteSpan;
import myandroid.text.style.RelativeSizeSpan;
import myandroid.text.style.ReplacementSpan;
import myandroid.text.style.ScaleXSpan;
import myandroid.text.style.StrikethroughSpan;
import myandroid.text.style.StyleSpan;
import myandroid.text.style.SubscriptSpan;
import myandroid.text.style.SuperscriptSpan;
import myandroid.text.style.TextAppearanceSpan;
import myandroid.text.style.TypefaceSpan;
import myandroid.text.style.URLSpan;
